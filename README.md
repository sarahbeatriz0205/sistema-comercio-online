...
- **Listagem de vendas:** Permite a listagem de todas as vendas já feitas
...
- **Cadastro de produtos:** Permite a listagem, inserção, atualização, exclusão e reajustes de preços de produtos

#### Entrando como cliente
- **Listagem de produtos:** Permite a listagem de todos os produtos cadastrados
- **Compra de produtos (Quero comprar):** Permite a inserção de produtos no carrinho, visualização do carrinho e finalização de uma compra
- **Listagem de compras:** Permite a listagem de todas as compras do cliente que está acessando o sistema no momento
...
- Ambiente de desenvolvimento: GitHub Codespaces e VSCode
